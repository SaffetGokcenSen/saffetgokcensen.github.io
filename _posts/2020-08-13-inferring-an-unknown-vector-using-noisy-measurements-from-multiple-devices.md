...
\begin{equation}
    \exp \left[\sum\_{k=1}^{m} -\frac{1}{2}\left(\bar{\mathbf{y}}\_{k}-\mathbf{x}\right)^{T}\frac{\boldsymbol{\Sigma}\_{k}}{N\_{k}}\left(\bar{\mathbf{y}}\_{k}-\mathbf{x}\right)\right]=-\frac{1}{2}\left (\begin{bmatrix}
        \bar{\mathbf{y}}\_{1} \newline
        \bar{\mathbf{y}}\_{2} \newline
        \bar{\mathbf{y}}\_{3} \newline
        \vdots \newline
